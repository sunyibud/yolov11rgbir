...
def add_integration_callbacks(instance):
    ...
    depend on the type of instance provided. All instances receive platform callbacks, while Trainer instances also
    receive additional callbacks for various integrations like ClearML, Comet, DVC, MLflow, Neptune, Ray Tune,
