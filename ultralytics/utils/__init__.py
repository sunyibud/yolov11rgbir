...
HELP_MSG = """
    ...
    3. Use the command line interface (CLI):
        ...
        Ultralytics 'yolo' CLI commands use the following syntax:
            ...
            Where   TASK (optional) is one of [detect, obb]
        ...
        - Predict a YouTube video using a pretrained OBB model at image size 320:
            yolo obb predict model=yolo11n-obb.pt source='https://youtu.be/LNwODJXcvt4' imgsz=320
...
class DataExportMixin:
    ...
    from object detection or OBB tasks into various formats: Polars
